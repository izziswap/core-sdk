...
import { IZZI_ADDRESS, USDC_ADDRESS, USD_ADDRESS, WETH9_ADDRESS, WNATIVE_ADDRESS } from './addresses'
...
export const IZZI: ChainTokenMap = {
  [ChainId.ETHEREUM]: new Token(ChainId.ETHEREUM, IZZI_ADDRESS[ChainId.ETHEREUM], 18, 'IZZI', 'IzziToken'),
  [ChainId.ROPSTEN]: new Token(ChainId.ROPSTEN, IZZI_ADDRESS[ChainId.ROPSTEN], 18, 'IZZI', 'IzziToken'),
  [ChainId.RINKEBY]: new Token(ChainId.RINKEBY, IZZI_ADDRESS[ChainId.RINKEBY], 18, 'IZZI', 'IzziToken'),
  [ChainId.GÖRLI]: new Token(ChainId.GÖRLI, IZZI_ADDRESS[ChainId.GÖRLI], 18, 'IZZI', 'IzziToken'),
  [ChainId.KOVAN]: new Token(ChainId.KOVAN, IZZI_ADDRESS[ChainId.KOVAN], 18, 'IZZI', 'IzziToken'),
  [ChainId.MATIC]: new Token(ChainId.MATIC, IZZI_ADDRESS[ChainId.MATIC], 18, 'IZZI', 'IzziToken'),
  [ChainId.FANTOM]: new Token(ChainId.FANTOM, IZZI_ADDRESS[ChainId.FANTOM], 18, 'IZZI', 'IzziToken'),
  [ChainId.XDAI]: new Token(ChainId.XDAI, IZZI_ADDRESS[ChainId.XDAI], 18, 'IZZI', 'IzziToken'),
  [ChainId.BSC]: new Token(ChainId.BSC, IZZI_ADDRESS[ChainId.BSC], 18, 'IZZI', 'IzziToken'),
  [ChainId.ARBITRUM]: new Token(ChainId.ARBITRUM, IZZI_ADDRESS[ChainId.ARBITRUM], 18, 'IZZI', 'IzziToken'),
  [ChainId.AVALANCHE]: new Token(ChainId.AVALANCHE, IZZI_ADDRESS[ChainId.AVALANCHE], 18, 'IZZI', 'IzziToken'),
  [ChainId.OKEX]: new Token(ChainId.OKEX, IZZI_ADDRESS[ChainId.OKEX], 18, 'IZZI', 'IzziToken'),
  [ChainId.HARMONY]: new Token(ChainId.HARMONY, IZZI_ADDRESS[ChainId.HARMONY], 18, 'IZZI', 'IzziToken'),
  [ChainId.HECO]: new Token(ChainId.HECO, IZZI_ADDRESS[ChainId.HECO], 18, 'IZZI', 'IzziToken'),
  [ChainId.CELO]: new Token(ChainId.CELO, IZZI_ADDRESS[ChainId.CELO], 18, 'IZZI', 'IzziToken'),
  [ChainId.MOONRIVER]: new Token(ChainId.MOONRIVER, IZZI_ADDRESS[ChainId.MOONRIVER], 18, 'IZZI', 'IzziToken'),
  [ChainId.FUSE]: new Token(ChainId.FUSE, IZZI_ADDRESS[ChainId.FUSE], 18, 'IZZI', 'IzziToken'),
  [ChainId.TELOS]: new Token(ChainId.TELOS, IZZI_ADDRESS[ChainId.TELOS], 18, 'IZZI', 'IzziToken'),
  [ChainId.MOONBEAM]: new Token(ChainId.MOONBEAM, IZZI_ADDRESS[ChainId.MOONBEAM], 18, 'IZZI', 'IzziToken'),
  [ChainId.KAVA]: new Token(ChainId.KAVA, IZZI_ADDRESS[ChainId.KAVA], 18, 'IZZI', 'IzziToken'),
  [ChainId.METIS]: new Token(ChainId.METIS, IZZI_ADDRESS[ChainId.METIS], 18, 'IZZI', 'IzziToken'),
}
